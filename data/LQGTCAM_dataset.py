...
class LQGTCAMDataset(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        ...
        self.sizes_LQ, self.sizes_GT, self.sizes_CLQ = None, None, None
    ...
    def __getitem__(self, index):
        ...
        # BGR to RGB, BRGA to RGBA for LQ, HWC to CHW, numpy to tensor
        if img_GT.shape[2] == 3:
            img_GT = img_GT[:, :, [2, 1, 0]]
            img_LQ = img_LQ[:, :, [2, 1, 0, 3]]
            img_NF = img_NF[:, :, [2, 1, 0]]
